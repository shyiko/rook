...
public class InsertRowsReplicationEvent extends RowsMutationReplicationEvent<List<Serializable[]>> {
    ...
    public InsertRowsReplicationEvent(long serverId, String schema, String table, List<Serializable[]> rows) {
        super(serverId, schema, table, rows);
    }

    public InsertRowsReplicationEvent(long serverId, String schema, String table, Serializable[] row) {
    ...
    public String toString() {
        ...
        sb.append("InsertRowsReplicationEvent");
